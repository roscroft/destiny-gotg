# from initdb import PvPAggregate, AccountMedals, PvEAggregate, Character

# stat_dict = { "kd" :(PvPAggregate, "killsDeathsRatio", "Kill/Death Ratio")
...
#             ,"scorepg" :(PvPAggregate, "scorepg", "Score per Game")
...
#             ,"akillspg" :(PvPAggregate, "abilityKillspg", "Ability Kills per Game")
#             ,"mkills" :(PvPAggregate, "weaponKillsMelee", "Total Number of Melee Kills")
#             ,"mkillspg" :(PvPAggregate, "weaponKillsMeleepg", "Melee Kills per Game")
#             ,"gkills" :(PvPAggregate, "weaponKillsGrenade", "Total Number of Grenade Kills")
#             ,"gkillspg" :(PvPAggregate, "weaponKillsGrenadepg", "Grenade Kills per Game")
...
#             # PvE below the line
#             ,"pvekd" :(PvEAggregate, "killsDeathsRatio", "Kill/Death Ratio")
#             ,"pvekda" :(PvEAggregate, "killsDeathsAssists", "Kill/Assists/Death Ratio")
#             ,"pvebgs" :(PvEAggregate, "bestSingleGameScore", "Best Single Game Score")
#             ,"pvelks" :(PvEAggregate, "longestKillSpree", "Longest Kill Spree")
#             ,"pvesuicides" :(PvEAggregate, "suicides", "Total Number of Suicides")
#             ,"pvesuicidespg":(PvEAggregate, "suicidespg", "Suicides per Game")
#             ,"pvemk" :(PvEAggregate, "bestSingleGameKills", "Best Single Game Kills")
#             ,"pvekills" :(PvEAggregate, "kills", "Total Number of Kills")
#             ,"pvekillspg" :(PvEAggregate, "killspg", "Kills per Game")
#             ,"pvedeaths" :(PvEAggregate, "deaths", "Total Number of Deaths")
#             ,"pvedeathspg" :(PvEAggregate, "deathspg", "Deaths per Game")
#             ,"pveassists" :(PvEAggregate, "assists", "Total Number of Assists")
#             ,"pveassistspg" :(PvEAggregate, "assistspg", "Assists Per Game")
#             ,"pvepkills" :(PvEAggregate, "precisionKills", "Total Number of Precision Kills")
#             ,"pvescore" :(PvEAggregate, "score", "Total score")
#             ,"pvescorepg" :(PvEAggregate, "scorepg", "Score per Game")
#             ,"pvetime" :(PvEAggregate, "secondsPlayed", "Total Seconds in PvE")
#             ,"pveakills" :(PvEAggregate, "abilityKills", "Total Number of Ability Kills")
#             ,"pveakillspg" :(PvEAggregate, "abilityKillspg", "Ability Kills per Game")
#             ,"pvemkills" :(PvEAggregate, "weaponKillsMelee", "Total Number of Melee Kills")
#             ,"pvemkillspg" :(PvEAggregate, "weaponKillsMeleepg", "Melee Kills per Game")
#             ,"pvegkills" :(PvEAggregate, "weaponKillsGrenade", "Total Number of Grenade Kills")
#             ,"pvegkillspg" :(PvEAggregate, "weaponKillsGrenadepg", "Grenade Kills per Game")
#             ,"pvegames" :(PvEAggregate, "activitiesEntered", "Total Number of Activities Entered")
#             ,"pvewins" :(PvEAggregate, "activitiesWon", "Total Number of Activities Won")
#             ,"pvelsl" :(PvEAggregate, "longestSingleLife", "Longest Single Life")
#             }

# medal_dict = { "activities" :(AccountMedals, "activitiesEntered", "Activities Entered")
...
# character_dict = {"grimoire" :(Character, "grimoire", "Grimoire Score")
#                 ,"lightlevel" :(Character, "light_level", "Highest Light LeveL")
#                 }
